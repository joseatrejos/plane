...
export default {
  ...
  worklog: {
    ...
    log_work: "Registrar trabalho",
    tracked_time: "Tempo registrado",
    time_tracking: {
      label: "Rastreamento de tempo",
      description: "Registre o tempo gasto em itens de trabalho e projetos.",
    },
    success: {
      saved: "Registro de trabalho criado com sucesso.",
      updated: "Registro de trabalho atualizado com sucesso.",
      deleted: "Registro de trabalho exclu?do com sucesso.",
    },
    validation: {
      add_duration: "Por favor, adicione uma dura??o",
      select_label: "Selecione um rótulo",
    },
  },
  ...
  project_settings: {
    ...
    features: {
      ...
      time_tracking: {
        ...
        description: "Registre e acompanhe o tempo gasto nos itens de trabalho deste projeto.",
        toggle_title: "Ativar rastreamento de tempo",
        toggle_description: "Os membros do projeto poderão registrar trabalho.",
      },
    },
  },
  project_cycles: {
