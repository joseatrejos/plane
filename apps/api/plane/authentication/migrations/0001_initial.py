# Generated by Django 4.2.27 on 2026-01-26 18:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('db', '0118_issueuserproperty_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('webhook', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='workspace_app_installations', to='db.webhook')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workspace', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='oauth_refresh_tokens', to='db.workspace')),
                ('workspace_app_installation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='oauth_refresh_tokens', to='authentication.workspaceappinstallation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.OAUTH2_PROVIDER_APPLICATION_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s', to=settings.AUTH_USER_MODEL)),
                ('workspace', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='oauth_grants', to='db.workspace')),
                ('workspace_app_installation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='oauth_grants', to='authentication.workspaceappinstallation')),
            ],
            options={
                'verbose_name': 'Grant',
